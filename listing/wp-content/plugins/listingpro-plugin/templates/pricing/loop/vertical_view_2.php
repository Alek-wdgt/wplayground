<?php
	...
	/* vertical view code */
							...
							<div class="lp-view-all-price-feature"><span data-hide="'.esc_html__('Hide All Features', 'listingpro-plugin').'" data-show="'.esc_html__('View All Features', 'listingpro-plugin').'" class="lp-hide-show-price-features" style="'.$left.'">'.esc_html__('View All Features', 'listingpro-plugin').'</span></div>';
								...
								<div class="lp-price-list">';
										...
										echo '<ul class="lp-listprc">
											...
											<li class="outer_tooltip_price">
												...
												echo  apply_filters('lp_price_plan_recurring_duration', '', get_the_ID(), 'vertical_view_2' );
