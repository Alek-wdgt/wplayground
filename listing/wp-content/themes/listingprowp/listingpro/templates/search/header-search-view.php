							...
							<div class="form-group lp-location-search <?php echo esc_attr($hideWhatClass); ?>">
								...
								<div data-option="<?php echo esc_attr($locOption); ?>" class="<?php echo esc_attr($srchBr); ?>">
								  ...
								  <?php
									if(!empty($sLoc)){
									?>
									<option id="def_location" value="<?php echo esc_attr($sLoc); ?>"><?php echo esc_attr($sLoc); ?></option>
									<?php
										}elseif(!empty($sLocation)){ ?>
										<option id="def_location" value="<?php echo esc_attr($sLocation); ?>"><?php echo esc_attr($sLocation); ?></option>
									<?php								
										}else{
									?>
