                ...
                if (!empty($plan_id)) {
                    ...
                    if (!empty($plan_duration) && empty($checkIfRecurriong)) {
                        ...
                        if ($res != false) {
                            ...
                            $u_mail_body  = isset($listingpro_options['listingpro_subject_listing_expired']) ? $listingpro_options['listingpro_subject_listing_expired'] : '';
                ...
                function downloadCSV() {
                  jQuery.ajax({
                    ...
                    success: function(response) {
                      var blob = new Blob([response], {type: 'text/csv;charset=utf-8;delimiter=;'}); 
