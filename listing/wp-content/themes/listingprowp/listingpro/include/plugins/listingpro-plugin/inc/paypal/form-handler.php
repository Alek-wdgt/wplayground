...
if(!function_exists('lp_form_handler')){
    function lp_form_handler($__POST, $__GET){
        ...
        if(!empty($__POST['post_id']) && isset($__POST['post_id']) && !empty($__POST['method']) && isset($__POST['method'])){
            ...
            $coupon = '';
            $copontype = '';
                $couponChek = isset($__POST['lp_checkbox_coupon']) ? $__POST['lp_checkbox_coupon'] : '';
            if(isset($__POST['coupon-text-field']) && $couponChek == 'couponON'){
                if(!empty($__POST['coupon-text-field'])){
                    $cCode = $__POST['coupon-text-field'];
            ...
            /*if( isset($__POST['coupon-text-field'])){
                if(!empty($__POST['coupon-text-field'])){
                    $couponCode =  $__POST['coupon-text-field'];
            ...
            if(isset($__POST['lp-recurring-option'])){
                $lpRecurring = $__POST['lp-recurring-option'];
                $_SESSION['lp_paypal_session'] = $lpRecurring;
            }

            $method = $__POST['method'];
            $post_id = $__POST['post_id'];
            $coupon = isset($__POST['coupon-text-field']) ? $__POST['coupon-text-field'] : '';
            $plan_price = $__POST['plan_price'];
            $user_id = get_current_user_id();
            ...
            if(!empty($Taxratee)){
                $taxprice = (float)$__POST['listings_tax_price'];
