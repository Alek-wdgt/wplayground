<?php get_header();?>
	...
	if ( have_posts() ) {
		while ( have_posts() ) {
            ...
            $blog_detail_template = isset($listingpro_options['blog_single_template']) ? esc_url($listingpro_options['blog_single_template']) : '';
            $blog_sidebar_style = isset($listingpro_options['blog_sidebar_style']) ? esc_url($listingpro_options['blog_sidebar_style']) : '';
